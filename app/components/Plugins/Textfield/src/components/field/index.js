  ...
  renderIcon() {
    ...
    if (iconName !== "") {
      if (iconType === 'FontAwesome') {
        return <Icon name={iconName} size={18} style={iconStyle} onPress={this.props.iconFunction} />
      }
      if (iconType === 'Entypo') {
        return <Entypo name={iconName} size={18} style={iconStyle} onPress={this.props.iconFunction} />
      }
      if (iconType === 'MaterialIcons') {
        return <MaterialIcons name={iconName} size={18} style={iconStyle} onPress={this.props.iconFunction} />
      }
      if (iconType === 'MaterialCommunityIcons') {
        return <MaterialCommunityIcons name={iconName} size={18} style={iconStyle} onPress={this.props.iconFunction} />
      }
      ...
      <View {...containerProps}>
        <Animated.View {...inputContainerProps}>
          {disabled && <Line {...lineProps} />}
           ...
           <Label {...labelProps} RTL={this.props.RTL}>{label}</Label> 

          <View style={styles.row}>
            {this.renderAffix('prefix', active, focused)}
            {this.renderIcon()}
            <TextInput
              style={[styles.input, { fontFamily: FONTFAMILY.POPPINS_MEDIUM, marginTop: 5, fontSize: 14 }, inputStyle, inputStyleOverrides]}
