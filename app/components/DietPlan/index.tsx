...
export default function ScrollPicker({
  ...
  const highlightWidth = '20%' //(isViewStyle(style) ? style.width : 0) || deviceWidth;
  ...
  const wrapperStyle: ViewStyle = {
    ...
    height: 50,
    flex: 1,
    backgroundColor: props.wrapperColor || "#FFFFFF",
    width: '100%',
    overflow: "hidden",
  ...
  const highlightStyle: ViewStyle = {
    ...
    height: itemHeight,
    width: '100%',//highlightWidth,
    borderTopColor: highlightColor,
    borderBottomColor: highlightColor,
    borderTopWidth: 4,//StyleSheet.hairlineWidth,
