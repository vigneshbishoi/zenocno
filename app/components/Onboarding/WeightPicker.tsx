...
export default function WeightPicker(props: any) {
    ...
    return (
        ...
        >
            ...
            <View style={{ justifyContent: 'center', alignContent: 'center', borderWidth: 1, flex: .25, height: '30%', width: '50%' }}>
                ...
                <ScrollPicker
                    ...
                    renderItem={(data, index) => {
                        return (
                            <View><Text style={{ fontSize: 26, fontFamily: FONTFAMILY.POPPINS_MEDIUM }}>{data}</Text></View>
                        )
                    }}
