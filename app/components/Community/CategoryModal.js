...
export default function CategoryModel(props: any) {
                    ...
                    return (
                        <View style={styles.item_container}>
                            <Pressable
                                ...
                                style={[styles.item, { backgroundColor: selected == item ? (theme.GHOST_WHITE) : (theme.PRIMARY) }]}>
                                <Text style={[styles.unselected_text, { color: selected != item ? theme.DARK_GRAY : theme.SECONDARY, }]} >{item}</Text>
                                {selected == item &&
