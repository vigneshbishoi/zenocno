...
import { getJournalCategoryList, getJournalList, getJournalSearchList } from '../store/actions/journalActions';
/**
 * Import Other files
 */
import * as ConfigFn from '../config/fn-config';
import { bindActionCreators } from 'redux';
const Journal: any = ConfigFn.getPluginFile('Journal');
...
const mapDispatchToProps = (dispatch) => {
  ...
  const language: any = {
    actions: {
      ...
      getJournalSearchList: bindActionCreators(getJournalSearchList, dispatch),
    }
  }
  return language
};
