 ...
 */
 ...
 const ChatSearchPeople: any = ConfigFn.getPluginFile('ChatSearchPeople');
  ...
  */
 const ChatSearchPeopleContainer = connect(mapStateToProps, mapDispatchToProps)(ChatSearchPeople);
 export default ChatSearchPeopleContainer;
