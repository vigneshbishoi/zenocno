...
const OncologistBooked: any = ConfigFn.getPluginFile('OncologistBooked');
 ...
 */
const OncologistBookedContainer = connect(mapStateToProps, mapDispatchToProps)(OncologistBooked);
export default OncologistBookedContainer;