 ...
 */
 ...
 const ChatAudio: any = ConfigFn.getPluginFile('ChatAudio');
  ...
  */
 const ChatAudioContainer = connect(mapStateToProps, mapDispatchToProps)(ChatAudio);
 export default ChatAudioContainer;
